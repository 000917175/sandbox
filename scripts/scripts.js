...
function changeModel(){
    var newText=document.getElementById("model-text");
    if (modelName=="XYZ"){
        modelName="CPRG";
        newText.innerHTML="Model CPRG";
    } else if (modelName=="CPRG"){
        modelName="XYZ";
        newText.innerHTML="Model XYZ";
    }
    recalculate();
}
...
function changeDuration(){
    ...
    duration=prompt("What duration would ypu like to rent the bot?");
